...
@mcp.tool()
def generate_hunyuan3d_model_via_text(
    ctx: Context,
    text_prompt: str,
) -> str:
    """
    Generate 3D asset using Hunyuan3D by giving description of the desired asset, and import the asset into Blender.
    The 3D asset has built-in materials.
...
def asset_creation_strategy() -> str:
    ...
    1. First use the following tools to verify if the following integrations are enabled:
        ...
        3. Hunyuan3D
            ...
            - For objects/models, do the following steps:
                1. Create the model generation task
                    - Use generate_hunyuan3d_model_via_images() if image is given
                    - Use generate_hunyuan3d_model_via_text() if generating 3D asset using text prompt

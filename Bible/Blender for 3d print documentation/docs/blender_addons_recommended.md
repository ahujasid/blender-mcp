...
**Status**: built-in in Blender 4.x, bundled. Già documentato in dettaglio in [blender_3d_print_toolbox].
...
**URL**: [extensions.blender.org/add-ons/threemf-io](https://extensions.blender.org/add-ons/threemf-io/) (Ghostkeeper lineage, update Jan 2026)
**Fork Blender 5.x**: [github.com/LeeGillie/Blender3mfFormat](https://github.com/LeeGillie/Blender3mfFormat)
...
bpy.ops.export_mesh.threemf(
    ...
    global_scale=1.0,           # con unit_settings corretto = già mm
    coordinate_precision=4,
)
```

**Valore**: handoff Bambu Studio formale. 3MF preserva multi-object, units esplicite, materiale → filament mapping (parzialmente, vedi [bambu_3mf_export]). Sostituisce workflow brittle multi-STL.

**Limiti noti**: Blender emette solo Core 3MF; Bambu's Production Extension (modifier mesh, negative parts, AMS filament IDs) **non è scrivibile da Blender** — vanno aggiunti in Bambu Studio post-import. Vedi [bambu_3mf_export] per i bug Issue #7775 / #6976 / #3316.

### 3. **Booltron** (`booltron`, mrachinskiy) — HIGH

**URL**: [extensions.blender.org/add-ons/booltron](https://extensions.blender.org/add-ons/booltron/), [GitHub](https://github.com/mrachinskiy/booltron) (v3.1 Mag 2025)
**License**: GPL
**MCP API**:
```python
